...
generate_animation_frames(mu_0, N_turns, L, R, points_per_turn, shift_distance, I, Grid_density, time_steps, output_folder, span_of_animation, Hz, rot_freq, Grid_size, model_choice)
