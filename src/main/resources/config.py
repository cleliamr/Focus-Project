...
magnet_center = np.array([0, 0, 0.2]) # Permanent magnet coordinates
magnet_dimensions = np.array([0.002, 0.002, 0.002]) # Permanent magnets dimensions
magnet_moment = np.array([100000/mu_0, 0, 0]) # Magnetization of magnet
