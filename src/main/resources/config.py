...
Grid_size = 0.02 # describes size of grid (x2)
...
span_of_animation = 25 # length of the animation
...
canc_vert_distance = 0.08 # vertical distance to origin / focus point
canc_hor_distance = 0.23 # distance between magnets
canc_magnet_dimensions = np.array([0.05, 0.03, 0.02])
